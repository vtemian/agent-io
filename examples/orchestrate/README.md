...
Chains agents together — when one completes (or errors), triggers the next action. Define pipelines in a JSON config and let the orchestrator watch your workspaces for matching agent events.
